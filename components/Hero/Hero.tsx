...
export default function Hero() {
  return (
    <section id="hero">
      <div className="container mx-auto flex h-[50vh] min-h-full flex-col justify-center px-4 text-zinc-50">
        <div className="flex flex-col gap-4">
          ...
          <div className="mt-8 text-center">
            <button className="text-md rounded bg-zinc-50 py-3 px-10 font-semibold text-zinc-900 transition-all duration-75 ease-in-out hover:scale-105 hover:bg-zinc-200">
              Get In Touch
            </button>
            <BannerSection />
          </div>
